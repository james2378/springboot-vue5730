<template>
	<div class="main-content" :style='{"padding":"0"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button :style='{"border":"5px solid #3FA8C4","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"rgba(63, 168, 196, 1)","borderRadius":"40px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('shangpinxinxi','仓储信息')" type="success" size="mini" @click="cangchuxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">仓储信息</el-button>
		...
		<cangchuxinxi-cross-add-or-update v-if="cangchuxinxiCrossAddOrUpdateFlag" :parent="this" ref="cangchuxinxiCrossaddOrUpdate"></cangchuxinxi-cross-add-or-update>
...
import cangchuxinxiCrossAddOrUpdate from "../cangchuxinxi/add-or-update";
export default {
  data() {
    return {
      ...
      cangchuxinxiCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    cangchuxinxiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.cangchuxinxiCrossAddOrUpdateFlag = true;
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.cangchuxinxiCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.cangchuxinxiCrossaddOrUpdate.init(row.id,type);
      });
    },
